        ...
        <div id='title-and-card-stream'>
          ...
          <div id="card-stream">
            ...
            <div id='who-am-i-card' className="card card-bottom-buffer">
              <p>
              Aspiring full-stack web developer motivated by a semantic and UX-conscious approach to web development and responsive web design, with an interest in Progressive Web Apps and learning emerging technologies. Comes from a background in fast-paced optical retail, developing skills in communication, teamwork and attention to detail. Completed a certificate in web development through USYD’s Coding Bootcamp, developing skills with industry leading technologies including MERN Stack, PWA tools like Webpack and Workbox, CSS libraries like Bootstrap and Ant Design, and paradigms like MVC and ORM/ODM.<br/>
                <br/>
